  ...
  return (
    ...
    >
      <div className="flex items-center justify-center px-6 py-4">
        ...
        {/* Centered Title with Government Branding */}
        <div className="text-center text-white flex flex-col items-center">
          <motion.h1
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.2, duration: 0.6 }}
            className="text-xl md:text-2xl font-extrabold tracking-wide bg-gradient-to-r from-white via-blue-50 to-white bg-clip-text text-transparent drop-shadow-lg whitespace-nowrap"
          >
          ...
          <motion.p
            ...
            className="text-sm md:text-base text-blue-50 opacity-95 font-medium tracking-wide mt-2 drop-shadow-sm"
          >
